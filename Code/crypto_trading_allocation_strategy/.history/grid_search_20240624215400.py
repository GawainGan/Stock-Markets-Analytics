...
def grid_search_2_params(btc_df, short_window_range, long_window_range):
    """
    ...
    for short_window in short_window_range:
        for long_window in long_window_range:
            ...
            for _, row in btc_df.iterrows():
                df_new_2 = update_dataframe_with_new_row(df_new_2, row, results_list, short_window, long_window, true_weight=1)
