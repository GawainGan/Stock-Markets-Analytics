...
# EMA
def calculate_ema(df, short_window=7, long_window=15):
    """
...
def calculate_weight_and_class(df, true_weight=1, high_weight=100, medium_weight=65, low_weight=30):
    """
    ...
    # define the second cases (weight = medium_weight% - 20%)
        ...
        weight_percentage = medium_weight-20
        class_type = '2.2'
    ...
    # define the third cases, the weight range is low (weight = low_weight% - 10%)
        ...
        weight_percentage = low_weight/2
        class_type = '3.1'
